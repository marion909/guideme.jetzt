...
if (isset($_POST["submit"])) {
    ...
    if ($_POST['pwd'] == 'CGMupload1!') {
        ...
        //if($FileType != "bmp" && $FileType != "cmd" && $FileType != "bat"
        //&& $FileType != "ps1"  && $FileType != "jpg" && $FileType != "jpeg" && $FileType != "pdf" && $FileType != "exe" && $FileType != "png" && $FileType != "msi" && $FileType != "zip") {
